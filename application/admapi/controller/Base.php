...
class Base extends Api
{
        ...
        if(!empty($name) && $name != 'all'){
            ...
            switch($name){
                ...
                case 'holidays':
                    ...
                    break;
                case 'pers':
                    $ret = config('admin_per_item.main');
                    break;
                default:
                    break;
            }
            ...
            $global_vars = ['dbservers','employees','roles','dicts','areas','holidays', 'pers'];
     ...
     * @return [type] [description]
     */
    protected function getEmployeesLists(){
        $employee   = model('employee')->select();
