...
CREATE TABLE `x360p_market_clue` (
  ...
  `cu_assigned_eid` int(11) NOT NULL DEFAULT '0' COMMENT '销售分配eid',
  `cu_assigned_bid` int(11) NOT NULL DEFAULT '0' COMMENT '销售分配校区',
...
CREATE TABLE `x360p_org` (
  ...
  `is_student_limit` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '是否限制学员数',
  `is_account_limit` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '是否限制账号数',
  `is_branch_limit` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '是否限制校区数',
  `student_num_limit` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '学员数量限制',
  `account_price` decimal(11,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '账号单价',
  `branch_price` decimal(11,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '校区单价',
  `student_price` decimal(11,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '学员单价',
  `default_wxmp` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '默认公众号0：用官方1：用总部',
  `renew_way` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '续费方式0:不允许自助续费，1:用总部，2：用官方',
