...
CREATE TABLE `x360p_class` (
  ...
  `grade` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '年级',
...
--
-- Table structure for table `x360p_serice_record`
--

DROP TABLE IF EXISTS `x360p_serice_record`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `x360p_serice_record` (
...
CREATE TABLE `x360p_student_lesson` (
  ...
  `fit_grade_start` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '适应年级start',
  `fit_grade_end` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '适应年级end',
...
CREATE TABLE `x360p_student_lesson_operate` (
  ...
  `og_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '机构ID',
  `bid` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '订单ID',
  `op_type` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '操作类型1：赠送,2:结转，3:退费',
  `sid` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '学生id',
