...
ADD COLUMN `cate`  tinyint NOT NULL DEFAULT 1 COMMENT '积分类型： 1学习积分，2消费积分' AFTER `type`;
...
ADD COLUMN `cate`  tinyint(4) NOT NULL DEFAULT 1 COMMENT '积分类型： 1学习积分，2消费积分' AFTER `type`;
...
CREATE TABLE `x360p_edu_growup` (
  ...
  PRIMARY KEY (`eg_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='成长对比表';
...
CREATE TABLE `x360p_edu_growup_item` (
  ...
  `update_time` int(11) unsigned DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`egi_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='成长对比记录';
...
CREATE TABLE `x360p_edu_growup_pic` (
  ...
  `update_time` int(11) unsigned DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`egp_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='成长对比图片表';
